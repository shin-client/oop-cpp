...
class DichVuThueXe : public DichVu {
 ...
 public:
  DichVuThueXe(int thoiGian, string loai)
      : DichVu("Thue xe"), thoiGianSuDung(thoiGian), loaiThue(loai) {}
  ...
  float tinhTien() const {
    if (loaiThue == "gio")
      return thoiGianSuDung * GIA_THUE_GIO;
    else if (loaiThue == "ngay")
      return thoiGianSuDung * GIA_THUE_NGAY;
  }
};
